...
import { listProductsDetail } from "../redux/actions/productActions";
          ...
          <Col md={3}>
            <Card>
              <ListGroup variant="flush">
                ...
                {/* Short way of saying : if prod.countInStock > 0 then foo , bc there is no else */}
                {/*/TODO  delelte this functionality?? or keep it (ask how client wants it)*/}
